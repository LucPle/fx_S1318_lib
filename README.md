...
- [프로젝트 요약](#-------)
- [fx_S1318 소개](#fx-s1318---)
    + [fx_S1318의 구조](#fx-s1318----)
    + [fx_S1318의 특징](#fx-s1318----)
- [프로젝트 파일 설명](#----------)
    + [main.c](#mainc)
    + [fx_S1318.h](#fx-s1318h)
    + [fx_S1318.c](#fx-s1318c)
    + [fund_calc.c: 고정소수점을 이용한 사칙연산 구현](#fund-calcc--------------------)
    + [trig_calc.c: 고정소수점을 이용한 삼각함수 구현](#trig-calcc--------------------)
    + [perf.c: 곱셈과 나눗셈 함수의 성능을 측정](#perfc--------------------)
    + [tobin.c: fx_S1318형태의 2진법 배열 생성](#tobinc--fx-s1318----2--------)
- [정밀도 및 구현 분석](#-----------)
- [속도 분석](#-----)
- [마무리](#---)
